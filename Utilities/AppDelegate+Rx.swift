...
extension RxSwift.Reactive where Base: UIApplication {
    ...
    public var applicationDidEnterBackground: Observable<ApplicationState> {
    ...
    public var appState: Observable<ApplicationState> {
        return Observable.of(
            applicationDidEnterBackground.map {_ in return ApplicationState.applicationDidEnterBackground }
            )
            .merge()
    }
}
